...
function IconHome({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="currentColor" strokeWidth={active ? 2 : 1.6}>
            ...
            return (
              <li key={href}>
                <Link
                  ...
                  href={href as any}
                  className="relative flex flex-col items-center justify-center gap-1 py-2 min-h-[56px] text-[10px] tracking-wide transition-colors"
